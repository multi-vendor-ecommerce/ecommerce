...
export const RenderVendorRow = (v, i) => (
  ...
  >
    ...
    <td className="px-6 py-3 min-w-[100px] hover:scale-105 transition duration-150">{v.productQuantity}</td>
    <td className="px-6 py-3 min-w-[140px] font-bold hover:scale-105 transition duration-150">
      ₹{(v.totalSales ?? 0).toLocaleString()}
    </td>
    <td className="px-6 py-3 min-w-[140px] text-left font-bold hover:scale-105 transition duration-150">
      ₹{(v.commissionRate ?? 0).toLocaleString()}
    </td>
    <td className="px-6 py-3 min-w-[150px] hover:scale-105 transition duration-150">{getFormatDate(v.registeredAt)}</td>
