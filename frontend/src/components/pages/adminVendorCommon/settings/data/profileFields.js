export const profileSections = [
  {
    ...
    fields: [
      { label: "Name", title: "Name", name: "name", type: "text", placeholder: "Enter your full name" },
      { label: "Email", title: "Can't change email", name: "email", type: "email", placeholder: "abc@example.com" },
    ],
  },
  {
    title: "Address Details",
    fields: [
      { label: "Address Line 1", title: "Address Line 1", name: "address.line1", type: "text", placeholder: "Street address, P.O. box, company name" },
      ...
      { label: "City", title: "City", name: "address.city", type: "text", placeholder: "e.g. Mumbai" },
      { label: "State", title: "State", name: "address.state", type: "text", placeholder: "e.g. Maharashtra" },
      { label: "Country", title: "Country", name: "address.country", type: "text", placeholder: "e.g. India" },
      { label: "Pincode", title: "Pincode", name: "address.pincode", type: "text", placeholder: "6-digit postal code" },
